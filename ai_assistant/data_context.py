...
def dataset_context(df: pd.DataFrame) -> str:
    ...
    return (
        ...
        "- T2M: Nhiệt độ trung bình ở độ cao 2m (°C)\n"
        "- T2M_MAX: Nhiệt độ cao nhất hàng ngày (°C)\n"
        "- T2M_MIN: Nhiệt độ thấp nhất hàng ngày (°C)\n"
        "- PRECTOTCORR: Lượng mưa tích lũy hàng ngày (mm/ngày)\n"
        ...
        "- region_vn / region: Vùng khí hậu (Tây Bắc, Đông Bắc, Đồng bằng sông Hồng, Bắc Trung Bộ, Duyên hải Nam Trung Bộ, Tây Nguyên)\n"
        "- location_vn / location_name: Tỉnh/Thành phố/Địa điểm tham chiếu\n"
        "- year: Năm (1991 - 2025)\n"
        "- month: Tháng (1 - 12)\n"
    )